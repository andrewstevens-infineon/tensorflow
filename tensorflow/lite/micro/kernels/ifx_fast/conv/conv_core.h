...
#ifndef TENSORFLOW_LITE_MICRO_KERNELS_IFX_FAST_CONV_CONV_CORE_H_
#define TENSORFLOW_LITE_MICRO_KERNELS_IFX_FAST_CONV_CONV_CORE_H_
...
#endif /* TENSORFLOW_LITE_MICRO_KERNELS_IFX_FAST_CONV_CONV_CORE_H_ */
