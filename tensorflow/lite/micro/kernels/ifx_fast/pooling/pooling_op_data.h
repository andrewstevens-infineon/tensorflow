...
#ifndef TENSORFLOW_LITE_MICRO_KERNELS_IFX_FAST_POOLING_POOLING_OP_DATA_H_
#define TENSORFLOW_LITE_MICRO_KERNELS_IFX_FAST_POOLING_POOLING_OP_DATA_H_
...
#define EVAL_FUNC_DECL(name)                                      \
  void name(const TfLiteContext* context, const TfLiteNode* node, \
...
#endif  // TENSORFLOW_LITE_MICRO_KERNELS_IFX_FAST_POOLING_POOLING_OP_DATA_H_
