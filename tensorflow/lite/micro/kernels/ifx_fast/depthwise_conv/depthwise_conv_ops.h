...
#ifndef TENSORFLOW_LITE_MICRO_KERNELS_IFX_FAST_DEPTHWISE_CONV_OPS_H_
#define TENSORFLOW_LITE_MICRO_KERNELS_IFX_FAST_DEPTHWISE_CONV_OPS_H_
...
#endif /* TENSORFLOW_LITE_MICRO_KERNELS_IFX_FAST_DEPTHWISE_CONV_OPS_H_ */
